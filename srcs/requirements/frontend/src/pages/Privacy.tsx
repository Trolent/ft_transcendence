...
export default function Privacy() {
  return (
    <PageLayout>
      ...
      <Text variant="dim"><u>Utilisation de vos données:</u> L'ensemble des données collectées nous permettent d'établir le leaderboard en temps réel, de sécuriser vos connexions, et de gérer le système d'amis. Nous nous engageons à garder une totale transparence quand aux données recueillies.</Text>
      <Text variant="dim"><u>Partage avec des tiers:</u> Nous ne vendons vos données en aucun cas.</Text>
    </PageLayout>
  );
}
