  ...
  if (i18n.language === "en") {
    return (
      <PageLayout>
        ...
        <Text variant="error">Thank you for using Typerun. Please read this terms of service agreement carefully.</Text>
        ...
        <Text><u>Cheating:</u> The use of bots, scripts or any other tool automating typing is prohibited, under penalty of invalidated score or even banishment from the leaderboard.</Text>
        ...
        <br />
        <Text><i><br />Last updated on May 21st, 2026</i></Text>
      </PageLayout>
    );
  }
    ...
    return (
      <PageLayout>
        ...
        <Text><u>Triche:</u> Il est interdit d'utiliser des bots, scripts ou tout autre outil automatisant la saisie, sous peine de score invalidé voire bannissement du leaderboard.</Text>
        ...
        <br />
        <Text><i><br />Dernière mise à jour le 21 mai 2026</i></Text>
      </PageLayout>
    );
  }
    ...
    return (
      <PageLayout>
        ...
        <Text><u>Trampas:</u> Está prohibido usar bots, scripts o cualquier otra herramienta que automatice la escritura, bajo pena de invalidación de la puntuación o incluso expulsión de la clasificación.</Text>
        ...
        <br />
        <Text><i><br />Última actualización el 21 de mayo de 2026</i></Text>
      </PageLayout>
    );
  }
}
