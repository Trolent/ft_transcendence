...
const usersData = [
  ...
  { username: 'thomas1',   email: 'thomas1@example.com'   },
  { username: 'chloe1',   email: 'chloe1@example.com'   },
  { username: 'lucas1',    email: 'lucas1@example.com'    },
  { username: 'emma1',      email: 'emma1@example.com'      },
  { username: 'hugo1',    email: 'hugo1@example.com'    },
  { username: 'lea1',      email: 'lea1@example.com'      },
  { username: 'maxime1',   email: 'maxime1@example.com'   },
  { username: 'sofia1',      email: 'sofia1@example.com'      },
  { username: 'nathan1',    email: 'nathan1@example.com'    },
  { username: 'camille1',   email: 'camille1@example.com'   },
  { username: 'theo1',     email: 'theo1@example.com'     },
  { username: 'pauline1', email: 'pauline1@example.com' },
  { username: 'romain1',    email: 'romain1@example.com'    },
  { username: 'jade1',   email: 'jade1@example.com'   },
